...
#   IO.inspect(System.get_env("PG_PASSWORD"), label: "Loaded PG_PASSWORD")
# end

env_dir_prefix = System.get_env("RELEASE_ROOT") || Path.expand("../envs", __DIR__)

IO.inspect(env_dir_prefix, label: "env_dir_prefix")
IO.inspect(Path.join(env_dir_prefix, ".env"), label: "Final path to .env")
...
# IO.inspect(System.get_env(), label: "Full env map")
