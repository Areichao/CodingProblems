defmodule Form do
  ...
  """
  # you can specify positive and negative or non negative integer
  ...
  # custom types
  # you can define elements of a map
  @type address_map :: %{street: String.t(), postal_code: String.t(), city: String.t()}
  # if all elements are of same type, you can define variable names
